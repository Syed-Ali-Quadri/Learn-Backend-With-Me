  ...
  const user = await User.aggregate([
    ...
    },
    {
      ...
      $lookup: {
        ...
        pipeline: [
          // Additional operations (pipeline) on the results from the "videos" collection
          {
            ...
            $lookup: {
              ...
              pipeline: [
                // Further operations to filter down the owner's data
                {
  ...
  return res
    ...
    .json(
      new ApiResponse(
        200,
        user[0].watchHistory,
        "User's watched history successfully fetched."
      )
